...
from keras.layers import Input, Conv2D, Conv2DTranspose, Activation, MaxPooling2D, Dropout, BatchNormalization, Lambda
...
def unet(pretrained_weights = None,
    ...
    out = Lambda(lambda x: backend.squeeze(x, 3))(conv10)
